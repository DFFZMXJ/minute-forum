<?php 
/**
 * SQLite driver for 5 Minute Forum.
 */
class Database{
    //Main class.
    ...
    public static function query($sql,$default=null){
        //Single mode, return the first one default.
    ...
    /*To support older version's database manager.*/
    ...
    public static function update(){
        /**
         * Updating function is unrealizable.
         */
    }
    public static function delete(){
        /**
         * It's unsupported in old version, to I won't try to realize it here.
         */
    }
}
class SQL {
